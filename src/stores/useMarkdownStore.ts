...
const DEFAULT_CONTENT = `Vditor 是一款**所见即所得**编辑器，支持 *Markdown*。
...
\\\`\\\`\\\`
![alt 文本](https://ts2.tc.mm.bing.net/th/id/ODF.gDnJqmfa_THR4N6naMFvbw?w=32&h=32&qlt=90&pcl=fffffa&o=6&pid=1.2)
![alt 文本](http://image-path.png "百度图标")
\\\`\\\`\\\`
